...
namespace BDD.Pages
{
    public class HomePage : BasePage
    {
        ...
        private readonly By _servicesLink = By.CssSelector("a.top-navigation__item-link[href='/services']");
        ...
        public void OpenHomePage()
        {
            ...
            WaitForPageLoad();
            Logger.LogInfo("Opened EPAM homepage");
        }
        public void AcceptCookies()
        {
            var cookieButton = WaitAndFindElement(_cookieAcceptButton);
        ...
        {
            var searchIconElement = WaitAndFindElement(_searchIcon);
        ...
        {
            var findButtonElement = WaitAndFindElement(_findButton);
        ...
        {
            var careers = WaitAndFindElement(_careersLink);
        ...
        {
            var insights = WaitAndFindElement(_insightsLink);
        ...
        {
            var aboutLinkElement = WaitAndFindElement(_aboutLink);
        ...
        {
            var servicesLink = WaitAndFindElement(_servicesLink);
            ClickElement(servicesLink);
            WaitForPageLoad();
            Logger.LogInfo("Navigated to Services page.");
